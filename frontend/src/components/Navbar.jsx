    ...
    <nav className="bg-government-navbarBg border-b border-government-navbarBorder w-full sticky top-0 z-50 flex flex-col">
      <div className="h-16 flex items-center justify-between px-6">
        ...
        >
          ...
          <ChevronDown
            size={16}
            className={`text-government-textMuted ml-1 transition-transform duration-200 ${showProfileMenu ? 'rotate-180' : ''}`}
          />
            ...
            <div className="absolute top-14 right-0 bg-white shadow-cardHover border border-government-border rounded-btn py-2 w-48 z-50 animate-slideDown">
              {officer.role === 'admin' && (
                <div
                  ...
                  onClick={(e) => { e.stopPropagation(); setShowProfileMenu(false); navigate('/officers'); }}
                >
                  <Users size={16} />
                  Manage Officers
                </div>
