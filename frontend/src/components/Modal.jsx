...
const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4 animate-fadeIn">
      <div className="bg-white rounded-[12px] shadow-cardHover w-full max-w-[560px] flex flex-col max-h-[90vh] animate-scaleIn">
        <div className="flex items-center justify-between p-4 border-b border-government-border">
          ...
          <button
            onClick={onClose}
            className="text-government-textMuted hover:text-government-primary hover:bg-government-surfaceHover p-1 rounded transition-colors"
          >
            <X size={20} />
          </button>
        </div>
